 ...
 */
final class Version20200416092154 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
       ...
       // $this->addSql('ALTER TABLE person RENAME INDEX fk_adresse TO IDX_34DCD1764DE7DC5C');
        $this->addSql('ALTER TABLE liker DROP FOREIGN KEY FK_AC6340B39514AA5C');
        $this->addSql('DROP INDEX IDX_AC6340B39514AA5C ON liker');
        $this->addSql('ALTER TABLE liker CHANGE id_post_id post_id INT NOT NULL');
        $this->addSql('ALTER TABLE liker ADD CONSTRAINT FK_3ECD7EEB4B89032C FOREIGN KEY (post_id) REFERENCES post (id)');
        $this->addSql('CREATE INDEX IDX_3ECD7EEB4B89032C ON liker (post_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comments CHANGE id_user_id id_user_id INT DEFAULT NULL, CHANGE id_post_id id_post_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE image CHANGE ad_id ad_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE liker DROP FOREIGN KEY FK_3ECD7EEB4B89032C');
        $this->addSql('DROP INDEX IDX_3ECD7EEB4B89032C ON liker');
        $this->addSql('ALTER TABLE liker CHANGE post_id id_post_id INT NOT NULL');
        $this->addSql('ALTER TABLE liker ADD CONSTRAINT FK_AC6340B39514AA5C FOREIGN KEY (id_post_id) REFERENCES post (id)');
        $this->addSql('CREATE INDEX IDX_AC6340B39514AA5C ON liker (id_post_id)');
