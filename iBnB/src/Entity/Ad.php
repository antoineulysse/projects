...
class Ad
{
    ...
    /**
     * @ORM\Column(type="string", length=1055)
     * @Assert\length(min=20, max=1055, minMessage="le titre doit faire plus de 20 caractères!")
     */
    ...
    /**
     * Permet d'obtenir la moyrenne globale des notes pour cette annonce
     * 
     * @return float
     * 
     */
    ...
    /**
     * Permet d'obtenir un tableau des jours qui ne sont pas dispo pour cet appart
     *
     * @return array un tableau d'objet DateTime représenatnt les jours d'oocupation
     */
