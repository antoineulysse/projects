 ...
 */
final class Version20200415122728 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
       ...
       // $this->addSql('ALTER TABLE person RENAME INDEX fk_adresse TO IDX_34DCD1764DE7DC5C');
        ...
        $this->addSql('ALTER TABLE image ADD upload LONGBLOB DEFAULT NULL, CHANGE ad_id ad_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comments CHANGE id_user_id id_user_id INT DEFAULT NULL, CHANGE id_post_id id_post_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE image DROP upload, CHANGE ad_id ad_id INT NOT NULL');
